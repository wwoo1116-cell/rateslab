            ...
            <VStack gap={2} width="100%">
              ...
              <Panel
                ...
                /* 둘 중 하나를 고르는 **배타 선택**이라 캐논 `Segmented` 다
                   ...
                   자연폭에 여유 — 「라벨이 길어지면 다시 잰다」가 이 주석의 끝
                   문장이고, **사람이 다시 재야 한다**는 것이 곧 RC2 다.
                   ⚠ 2026-09-23 에 유도로 옮기려다 **되돌렸다** — 알약은
                   `.sr-ctlfont`(14px/600)를 쓰는데 컨트롤 **값**은 13px/400 이다.
                   값 폰트로 재면 상자가 좁아져 알약이 **넘친다**(실측 −1.5px).
                   알약용 탐침이 따로 필요하고, 그건 다음 회차다. */
                aside={
                  <Box width={132}>
                    <Segmented
                      fill
